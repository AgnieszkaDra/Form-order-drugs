...
export const pesel = document.getElementById('pesel')
...
export const textareaPinPesel = document.querySelector('.textarea.pinpesel')
export const form = document.querySelector('.orderDrugsForm.button')
console.log(form)